...
describe MyApp do
  ...
  before(:all) do
    ...
    sim_card = SimCard.create!(:enabled => true,
  ...
  it 'test_3g_request had no sim_card binbed should bind a new sim_card' do
    ...
    CardBinding.stub(:where, []) do
      sim_card = SimCard.create(:enabled => true, :data_files => "everything fine", :mcc => 'mcc', :mnc => 'mnc')
  ...
  it 'test_3g_request had no more sim_card to bind should return 501' do
    ...
    CardBinding.stub(:where, []) do
      sim_card = SimCard.create(:enabled => true, :data_files => "everything fine")
      SimCard.stub(:free_cards, []) do
        post '/3g', request_body, "CONTENT_TYPE"=>"application/octet-stream"
      end
    end
